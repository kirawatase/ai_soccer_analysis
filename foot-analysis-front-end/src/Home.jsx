...
const Home = () => {
  return (
    <div className="relative w-full flex flex-col m-0">
      ...
      <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center px-8 text-center font-apple text-lg leading-relaxed font-normal z-10">  {/* Adjusted padding to pt-16 */}
      ...
      {/* Motivations Section */}
      <div className="bg-gray-900 w-full pt-10">  {/* Added padding-top of 10 */}
...
//       {/* Text Content Overlay */}
//       <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center px-8 text-center font-apple text-lg leading-relaxed font-normal z-10">
//         <div className="text-4xl font-bold mb-8 text-white">  {/* Increased bottom margin */}
//           Level Up Your Game with AI
//         </div>
